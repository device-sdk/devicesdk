...
For a full walkthrough, see the [Inter-Device Communication Guide](/guides/inter-device-communication/).
...
See [Cron Scheduling](/concepts/cron-scheduling/) for a full reference.

## Next Steps

- [Your First Device](/first-device/) - Build a complete example
- [Platform Architecture](/concepts/architecture/) - System overview
- [Cron Scheduling](/concepts/cron-scheduling/) - Run periodic tasks on a schedule
