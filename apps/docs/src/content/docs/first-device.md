...
A device entrypoint is a TypeScript class that handles communication between your devices and the script code running on your DeviceSDK server.
...
- [**Platform Architecture**](/concepts/architecture/) - See how it all works
- [**Inter-Device Communication**](/guides/inter-device-communication/) - Call methods between devices

## Need Help?

- [Join our Discord](https://discord.gg/WuNhbXGsBy) for community support
- [View examples](https://github.com/device-sdk/devicesdk/tree/main/examples) for more code samples
