...
The ESP32-C3 is Espressif's budget single-core RISC-V chip - cheap, low-power, and still feature-complete for DeviceSDK. Unlike the classic [ESP32](/hardware/esp32/), the C3 has the RMT peripheral, which DeviceSDK uses to drive WS2812 addressable LED strips directly.
...
See the [flash command reference](/cli/flash/#esp32-flashing-process).
