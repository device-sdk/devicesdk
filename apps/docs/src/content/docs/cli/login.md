...
- [`missing_credentials`](/errors/missing_credentials/) - error reference for the unauthenticated path.
- [`invalid_cli_token`](/errors/invalid_cli_token/) - error reference for the expired/revoked path.
- [`devicesdk env`](/concepts/env-vars/) - for project-scoped *secrets*; tokens are user-scoped.
