...
- [Entrypoints](/concepts/entrypoints/) - how device classes connect to slugs
- [Inter-Device Communication](/guides/inter-device-communication/) - calling methods on other devices by slug
- [`devicesdk` CLI reference](/cli/) - every command that takes a slug
