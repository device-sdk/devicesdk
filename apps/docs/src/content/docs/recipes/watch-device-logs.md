...
- [Real-time watch guide](/guides/real-time-watch/) - full WebSocket protocol reference.
- [`emitState`](/concepts/emit-state/) - how to push custom state into the stream.
- [`devicesdk logs`](/cli/logs/) - the CLI command reference.
