...
- [Hardware Compatibility](/hardware/) -- full feature availability table
- [Using SPI](/guides/using-spi/) -- communicate with SPI displays and sensors
- [Using UART](/guides/using-uart/) -- serial communication with GPS and Bluetooth modules
