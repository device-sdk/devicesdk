...
**Trust model:**
- Only deploy scripts you wrote or have reviewed.
- Do not give dashboard access to untrusted users — they can deploy arbitrary scripts.
- If you want to run untrusted scripts, put them in a separate DeviceSDK instance isolated from your other devices and data.
