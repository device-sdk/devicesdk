...
`Pico.i2c` validates pin pairs at compile time - pass an invalid combination and TypeScript flags it before you deploy. See the [Pico pinout](/hardware/pico-w/) for the full list of valid pin pairs per bus.
...
- [`SSD1306` helper](/recipes/oled-live-data/) - full OLED display recipe.
- [Read a BME280 sensor](/recipes/read-bme280/) - full temperature+humidity recipe.
- [Pico W pinout](/hardware/pico-w/) - valid I2C pin combinations.
