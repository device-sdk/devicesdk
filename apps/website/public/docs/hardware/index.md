...
- [ESP32-C3](http://localhost:1313/docs/hardware/esp32-c3/index.md) — Single-core RISC-V with 2.4GHz WiFi and WS2812 via RMT
- [ESP32](http://localhost:1313/docs/hardware/esp32/index.md) — Classic dual Xtensa LX6 with 2.4GHz WiFi
- [ESP32-C61](http://localhost:1313/docs/hardware/esp32-c61/index.md) — Single-core RISC-V with WiFi 6 and WS2812 via SPI backend
- [Raspberry Pi Pico 2W](http://localhost:1313/docs/hardware/pico-2w/index.md) — RP2350 dual Cortex-M33 with 2.4GHz WiFi, Pico W pin-compatible
- [Raspberry Pi Pico W](http://localhost:1313/docs/hardware/pico-w/index.md) — RP2040 dual ARM Cortex-M0+ with 2.4GHz WiFi
