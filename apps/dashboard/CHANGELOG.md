...
- 0cb8db2: Dashboard UI/UX, accessibility, and resilience overhaul from a full audit:
...
- ff1b736: Add usage-metrics charts to the dashboard, backed by the metrics API:
