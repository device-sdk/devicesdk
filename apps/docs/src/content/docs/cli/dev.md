...
- [`devicesdk build`](/cli/build/) - bundle without serving the simulator.
- [`devicesdk deploy`](/cli/deploy/) - push to your server.
- [`devicesdk inspect`](/cli/inspect/) - drive a *real* device interactively.
