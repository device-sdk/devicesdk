    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center fade-up">
        <div>
          ...
          <div class="mt-8 space-y-3 reveal-stagger">
        ...
        <div class="code-window terminal">
          ...
          <pre><code><span class="text-zinc-500">$</span> devicesdk login --host http://192.168.1.50:8080
...
<span class="text-emerald-400">&#10003;</span> Firmware flashed successfully</code></pre>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center fade-up">
        <div class="order-2 lg:order-1">
          <div class="code-window">
            <div class="code-window-bar">
              <div class="code-window-dots"><span></span><span></span><span></span></div>
              <span class="code-window-title">src/devices/thermostat.ts</span>
            </div>
    ...
    <span class="syn-kw">if</span> (message.type === <span class="syn-str">"gpio_state_changed"</span>) {
      ...
      <span class="syn-kw">if</span> (message.payload.state === <span class="syn-str">"low"</span>) {
        ...
        <div class="order-1 lg:order-2">
          ...
          <div class="mt-8 space-y-4 text-sm reveal-stagger">
  ...
  <section class="py-20 px-4 sm:px-6 lg:px-8 border-t border-zinc-800">
    <div class="max-w-4xl mx-auto fade-up">
      <div class="text-center mb-12">
        ...
        <p class="mt-4 text-zinc-400 text-lg">Web dashboard served by your own server at <code class="text-sm font-mono bg-zinc-900 px-1.5 py-0.5 rounded border border-zinc-800">http://&lt;server&gt;:8080</code></p>
      </div>

      <div class="space-y-0 border border-zinc-800 rounded-xl overflow-hidden reveal-stagger">
