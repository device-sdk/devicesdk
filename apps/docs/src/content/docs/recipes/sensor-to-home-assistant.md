...
1. Install the [DeviceSDK HA integration](/guides/home-assistant/) (one-time per HA instance).
...
- See the [Home Assistant guide](/guides/home-assistant/) for the full entity schema.
