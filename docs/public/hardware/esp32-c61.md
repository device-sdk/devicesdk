...
- **Bootloader offset `0x0`.** Same layout as ESP32-C3. Pre-built artifact is `esp32c61-client.bin`; see the [local flashing section in CLAUDE.md](/docs/cli/flash/#esp32-flashing-process) for the exact flash layout.
