...
Authenticate the CLI against the server you just started:
...
New log entries stream in as they arrive. Press **Ctrl-C** to stop. See [`devicesdk logs`](/cli/logs/) for filtering by level and other options.
...
See [**Environment Variables**](/concepts/env-vars/) for the full reference.

## Next Steps

Now that you have a working project:

- [**Your First Device**](/first-device/) - Learn how to build device entrypoints
- [**CLI Reference**](/cli/) - Explore all available commands
- [**Environment Variables**](/concepts/env-vars/) - Store secrets outside your code
- [**Platform Architecture**](/concepts/architecture/) - Understand how DeviceSDK works

## Need Help?

- [Join our Discord](https://discord.gg/WuNhbXGsBy) for community support
- [Check the FAQ](/resources/faq/) for common questions
- [View troubleshooting guide](/resources/troubleshooting/) if you encounter issues
