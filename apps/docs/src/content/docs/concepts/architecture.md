...
[`@devicesdk/core`](/concepts/device-api/) and surfaces as a
...
- [Device Entrypoints](/concepts/entrypoints/) - Lifecycle and methods
- [Script Versioning](/concepts/versioning/) - Deployment model
