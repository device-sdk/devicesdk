...
Without this, the session cookie can be transmitted over HTTP and may be intercepted. See the [self-hosting guide](/guides/self-hosting/) for reverse proxy setup.
