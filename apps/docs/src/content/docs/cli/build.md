...
- [`devicesdk deploy`](/cli/deploy/) - push the build to your server.
- [`devicesdk dev`](/cli/dev/) - run the simulator (calls `build` internally).
- [Device entrypoints](/concepts/entrypoints/) - what your `main` file should look like.
